...
namespace Simhub_R3E_Extra_properties_plugin.Models.Sector.Tests
{
    ...
    public class SectorColorTests
    {
        ...
        public void ColorConverterTest()
        {
            ...
            time = new Sector.SectorTime(null, 300, 100, 200);
